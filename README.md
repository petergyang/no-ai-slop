...
4. `.codex-plugin/plugin.json`: Metadata for the ChatGPT and Codex plugin.
5. `scripts/build_plugin.py`: Builds and validates the plugin ZIP from the canonical skill files.
